...
tmux send-keys -t "$SESSION:0.1" \
  "source /opt/ros/jazzy/setup.bash && cd ~/EmbeddedProj/src && sleep 2 && echo '=== [2] Starting SLAM Bridge ===' && INVERT_ODOM_YAW=0 ODOM_TRACK_WIDTH_FACTOR=1.185 python3 slam_bridge.py" C-m
